...
async def test_full_flow_returning_caller_memory():
    ...
    assert profile_after_call1["facts"]["eligibility_answers"]["is_small_farmer"] == "true"
    ...
    custom_instructions = SYSTEM_PROMPT + f"""
...
"""
    ...
    lookup_res = await assistant2.lookup_caller_profile(context=None, user_id=test_user_id)
